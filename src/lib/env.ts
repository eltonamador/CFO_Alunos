...
const envSchema = z.object({
  ...
  SCHEDULE_OCR_PROVIDER: z.enum(["disabled", "local_tesseract"]).default("disabled"),
  SCHEDULE_OCR_LANGUAGE: z.string().regex(/^[a-z0-9_+.-]+$/).default("por"),
...
const parsed = envSchema.safeParse({
  ...
  SCHEDULE_OCR_PROVIDER: process.env.SCHEDULE_OCR_PROVIDER,
  SCHEDULE_OCR_LANGUAGE: process.env.SCHEDULE_OCR_LANGUAGE,
