...
function fullBundle(): StudentProfileBundle {
  return {
    ...
    health: {
      ...
      has_allergies: false,
      has_continuous_medication: false,
      has_chronic_disease: false,
      has_physical_restriction: false,
      has_dietary_restriction: false,
      has_eye_surgery: false,
      allergies: null,
      ...
      medical_doc_waived_reason: null,
      medical_doc_waived_by: null,
      medical_doc_waived_at: null,
    },
    logistics: {
      student_id: "s-1",
